					...
					<div class="widget wgreen">
						...
						<div class="widget-content">
							<div class="padd">
								...
								<!-- Form starts.  -->
								<form class="form-horizontal" role="form" id="inputForm" action="${ctx}/admin/permission/update" method="post" autocomplete="off">
									<input type="hidden" name="id" value="${permission.id }"/>
									<div class="form-group">
										<label class="col-lg-4 control-label" for="name">权限名</label>
										<div class="col-lg-8">
											<input type="text" id="name" name="name"
												class="form-control required" placeholder="权限名称" value="${permission.permission}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
