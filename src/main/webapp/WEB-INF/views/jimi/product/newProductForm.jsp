...
<body>	
	...
	<div class="page-head">
		...
		<h2 class="pull-left">
			产品管理
			<!-- page meta -->
			<span class="page-meta">Product Management</span>
		</h2>
					...
					<div class="widget wgreen">
						...
						<div class="widget-content">
							<div class="padd">
								...
								<!-- Form starts.  -->
								<form class="form-horizontal" role="form" id="inputForm" action="${ctx}/jimi/product/" method="post" autocomplete="off">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="product" name="product"
												class="form-control required" placeholder="产品名称">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="purchasePrice" name="purchasePrice"
												class="form-control" placeholder="进价">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="price" name="price"
												class="form-control required" placeholder="售价">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input type="text" id="image" name="image"
												class="form-control required" placeholder="图片">
										</div>
									</div>
									<div class="form-group">
