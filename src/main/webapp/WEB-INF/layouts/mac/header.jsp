          ...
          <ul class="nav nav-pills">
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="glyphicon glyphicon-edit"></i> 聊天 <span   class="label label-info">6</span> 
              </a>

                <ul class="dropdown-menu">
                  <li>
                    <!-- Heading - h5 -->
                    <h5><i class="glyphicon glyphicon-comments"></i> 聊天</h5>
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="glyphicon glyphicon-envelope"></i> 收件箱 <span class="label label-primary">6</span> 
              </a>

                <ul class="dropdown-menu">
                  <li>
                    <!-- Heading - h5 -->
                    <h5><i class="glyphicon glyphicon-envelope-alt"></i> 消息</h5>
                    <!-- Use hr tag to add border -->
                    <hr />
                  </li>
                  <li>
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="glyphicon glyphicon-user"></i> 用户 <span   class="label label-success">6</span> 
              </a>

                <ul class="dropdown-menu">
                  <li>
                    <!-- Heading - h5 -->
                    <h5><i class="glyphicon glyphicon-user"></i> 用户</h5>
                    <!-- Use hr tag to add border -->
                    <hr />
                  </li>
                  <li>
          ...
          <div class="header-data">
            ...
            <div class="hdata">
              <div class="mcol-left">
                ...
                <i class="glyphicon glyphglyphicon glyphicon-signal bred"></i> 
              </div>
            ...
            <div class="hdata">
              <div class="mcol-left">
                ...
                <i class="glyphicon glyphicon-yen bgreen"></i> 
              </div>
              <div class="mcol-right">
                <!-- Number of visitors -->
